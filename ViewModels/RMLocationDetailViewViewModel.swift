...
class RMLocationDetailViewViewModel {
    ...
    enum SectionType {
        case information(viewModels: [RMEpisodeInfoCollectionViewCellModel])
   ...
   public weak var delegate: RMLocationDetailViewViewModelDelegate?
    ...
    private func createCellViewModels() {
        ...
        if  let date = RMCharacterInfoCollectionViewCellModel.dateFormatter.date(from: location.created) {
            createdString = RMCharacterInfoCollectionViewCellModel.shortDateFormatter.string(from: date)
            location.created
