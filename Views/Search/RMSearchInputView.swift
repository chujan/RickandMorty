...
class RMSearchInputView: UIView {
    ...
    private func  createOptionSelectionViews(options: [RMSearchInputViewViewModel.DynamicOption]) {
     let stackView = createOptionStackView()
        ...
        for x in 0..<options.count {
            ...
            let button = createdButton(with: option, tag: x)
    ...
    private func createdButton(with option: RMSearchInputViewViewModel.DynamicOption, tag: Int) -> UIButton {
        let button = UIButton()
        button.setAttributedTitle(NSAttributedString(string: option.rawValue, attributes: [.font: UIFont.systemFont(ofSize: 18, weight: .medium),
    ...
    public func update(option: RMSearchInputViewViewModel.DynamicOption, value: String) {
        ...
        buttons[index].setAttributedTitle(NSAttributedString(string: value.uppercased(), attributes: [.font: UIFont.systemFont(ofSize: 18, weight: .medium),
